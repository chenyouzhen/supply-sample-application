...
public class LinkResource {
     ...
     */
    @GetMapping("/links")
    public List<LinkDTO> getAllLinks(@RequestParam(required = false) String filter) {
        if ("assemblyline-is-null".equals(filter)) {
            log.debug("REST request to get all Links where assemblyline is null");
            return linkService.findAllWhereAssemblylineIsNull();
        }
